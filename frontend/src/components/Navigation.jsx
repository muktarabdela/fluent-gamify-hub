...
const Navigation = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-[#1c2b36] glass-effect border-t border-white/10 px-2 py-2 z-50">
        ...
        <div className="flex justify-between items-center relative">
          {navItems.map(({ icon: Icon, label, path }) => {
            ...
            return (
              ...
              >
                <Icon className={cn(
                  "h-6 w-6 transition-transform duration-200 text-gray-200  ",
                  isActive && "scale-110"
                )} />
                <span className={cn(
